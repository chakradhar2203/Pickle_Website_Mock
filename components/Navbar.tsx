...
export default function Navbar() {
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 h-[130px] backdrop-blur-xl bg-white/80 border-b border-gray-200/50">
            <div className="max-w-7xl mx-auto px-6 h-full flex items-center">
                {/* Logo */}
                <Link href="/" className="flex items-center group mr-auto">
                    {/* PNG Logo */}
                    <div className="relative w-[140px] h-[140px] mt-2 transition-transform group-hover:scale-110">
                        <Image
